...
abstract class _Paths {
  ...
  static const UPDATE_KATEGORI = '/kategori/update';
  static const SHOW_KATEGORI = '/kategori/show';
  static const TAG = '/tag';
  static const CREATE_TAG = '/tag/create';
  static const UPDATE_TAG = '/tag/update';
